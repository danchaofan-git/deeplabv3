...
def deeplabv3_resnet50(aux, num_classes=21, pretrain_backbone=False):
    ...
    if pretrain_backbone:
        if not os.path.exists('./resnet50-0676ba61.pth'):
            print('dowmload pretrain weight from https://download.pytorch.org/models/resnet50-0676ba61.pth')
            download_weights('resnet50', './')

        print('load pretrain backbone from resnet50-0676ba61.pth')
